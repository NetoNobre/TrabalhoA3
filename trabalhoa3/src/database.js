...
const ferramenta =  [

        {
            ...
            sobre:"O Visual Studio Code (VS Code) é um editor de código-fonte desenvolvido pela Microsoft. Ele é altamente elogiado pela sua leveza, rapidez e pela vasta gama de extensões que oferece, tornando-o uma escolha popular entre desenvolvedores de software de diversos tipos.",
...

        {
            ...
            sobre: "O Eclipse é uma IDE (Integrated Development Environment) de código aberto amplamente utilizada para o desenvolvimento de software em várias linguagens, mas é mais conhecida por ser uma das principais ferramentas para desenvolvimento em Java. ",
...

        {
            ...
            sobre: "O IntelliJ IDEA é uma poderosa IDE (Integrated Development Environment) desenvolvida pela JetBrains, projetada principalmente para desenvolvimento em Java, mas também oferece suporte a uma ampla gama de outras linguagens de programação, como Kotlin, Scala, Groovy, JavaScript, TypeScript e mais.",
...

        {
            ...
            sobre: "Adobe XD é uma ferramenta de design e prototipação desenvolvida pela Adobe. Ele permite que os designers criem protótipos interativos de aplicativos e sites com facilidade, sem a necessidade de escrever código. O Adobe XD oferece uma variedade de recursos, como ferramentas de design vetorial, animações, transições, prototipagem de alta fidelidade e colaboração em tempo real. Ele é amplamente utilizado por designers e equipes de desenvolvimento para criar protótipos visuais e testar a usabilidade de interfaces de usuário.",
